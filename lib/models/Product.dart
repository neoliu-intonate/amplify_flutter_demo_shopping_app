...
class Product extends amplify_core.Model {
  ...
  const Product._internal({required this.id, required name, description, required stock, required price, createdAt, updatedAt}): _name = name, _description = description, _stock = stock, _price = price, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Product({String? id, required String name, String? description, required int stock, required double price}) {
  ...
  Product copyWith({String? name, String? description, int? stock, double? price}) {
    return Product._internal(
      id: id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'description': _description, 'stock': _stock, 'price': _price, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
